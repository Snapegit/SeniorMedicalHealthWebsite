<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="药物名称" prop="yaowumingcheng">
					<el-input v-model="ruleForm.yaowumingcheng" placeholder="药物名称" clearable  :readonly="ro.yaowumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="药物名称" prop="yaowumingcheng">
					<el-input v-model="ruleForm.yaowumingcheng" placeholder="药物名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="剂量" prop="jiliang">
					<el-input v-model="ruleForm.jiliang" placeholder="剂量" clearable  :readonly="ro.jiliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="剂量" prop="jiliang">
					<el-input v-model="ruleForm.jiliang" placeholder="剂量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="服用时间" prop="fuyongshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.fuyongshijian" 
						type="datetime"
						:readonly="ro.fuyongshijian"
						placeholder="服用时间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.fuyongshijian" label="服用时间" prop="fuyongshijian">
					<el-input v-model="ruleForm.fuyongshijian" placeholder="服用时间" readonly></el-input>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.fuyongshijian = this.getCurDateTime()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiliang'){
							this.ruleForm.jiliang = obj[o];
							this.ro.jiliang = true;
							continue;
						}
						if(o=='fuyongshijian'){
							this.ruleForm.fuyongshijian = obj[o];
							this.ro.fuyongshijian = true;
							continue;
						}
						if(o=='beizhu'){
				...
				this.$http({ 
					...
					if (data && data.code === 0) { 
						if(data.data.total>=crossoptnum) {
							...
							this.$http({
								url: `fuyaojilu/${!this.ruleForm.id ? "save" : "update"}`,
								method: "post",
								data: this.ruleForm
							}).then(({ data }) => {
								if (data && data.code === 0) {
									this.$message({
										...
										onClose: () => {
											...
											this.parent.fuyaojiluCrossAddOrUpdateFlag = false;
											this.parent.search();
