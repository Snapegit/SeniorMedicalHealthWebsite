<template>
	<div class="addEdit-block" :style='{"padding":"0px 0px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="食物名称" prop="shiwumingcheng">
					<el-input v-model="ruleForm.shiwumingcheng" placeholder="食物名称" clearable  :readonly="ro.shiwumingcheng"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="食物名称" prop="shiwumingcheng">
					<el-input v-model="ruleForm.shiwumingcheng" placeholder="食物名称" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-if="type!='info' && !ro.shiwutupian" label="食物图片" prop="shiwutupian">
					<file-upload
						tip="点击上传食物图片"
						action="file/upload"
						:limit="3"
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="upload" v-else-if="ruleForm.shiwutupian" label="食物图片" prop="shiwutupian">
				...
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="饮食分量" prop="yinshifenliang">
					<el-input v-model="ruleForm.yinshifenliang" placeholder="饮食分量" clearable  :readonly="ro.yinshifenliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="饮食分量" prop="yinshifenliang">
					<el-input v-model="ruleForm.yinshifenliang" placeholder="饮食分量" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="饮食频率" prop="yinshipinlv">
					<el-input v-model="ruleForm.yinshipinlv" placeholder="饮食频率" clearable  :readonly="ro.yinshipinlv"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="饮食频率" prop="yinshipinlv">
					<el-input v-model="ruleForm.yinshipinlv" placeholder="饮食频率" readonly></el-input>
				</el-form-item>
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='yinshifenliang'){
							this.ruleForm.yinshifenliang = obj[o];
							this.ro.yinshifenliang = true;
							continue;
						}
						if(o=='yinshipinlv'){
							this.ruleForm.yinshipinlv = obj[o];
							this.ro.yinshipinlv = true;
							continue;
						}
						if(o=='zhuyishixiang'){
