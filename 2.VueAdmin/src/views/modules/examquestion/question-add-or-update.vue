<template>
  <div :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
    <el-form
      ...
      label-width="150px"
    >
      <el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="选择健康测试" prop="paperid">
      ...
      <el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' label="试题" prop="questionname">
        <el-input
          type="textarea"
          min="1"
