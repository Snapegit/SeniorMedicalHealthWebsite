  ...
  <div :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
    ...
    >  
     <el-row>
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yisheng'"  label="专业擅长" prop="zhuanyeshanzhang">
          <el-input v-model="ruleForm.zhuanyeshanzhang"               placeholder="专业擅长" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-if="flag=='yisheng'"  label="职称" prop="zhicheng">
        ...
        <el-form-item :style='{"width":"48%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}'   v-if="flag=='yisheng'"  label="电话" prop="dianhua">
          <el-input v-model="ruleForm.dianhua"               placeholder="电话" clearable></el-input>
        </el-form-item>
