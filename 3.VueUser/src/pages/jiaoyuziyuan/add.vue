...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="资源类型" prop="ziyuanleixing">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="资源文件" prop="ziyuanwenjian">
            <file-upload
            tip="点击上传资源文件"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="资源视频" v-if="type!='cross' || (type=='cross' && !ro.ziyuanshipin)" prop="ziyuanshipin">
            <file-upload
            tip="点击上传资源视频"
            action="file/upload"
            :limit="1"
		  ...
		  <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="资源视频" prop="ziyuanshipin">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="资源图片" v-if="type!='cross' || (type=='cross' && !ro.ziyuantupian)" prop="ziyuantupian">
            <file-upload
            tip="点击上传资源图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="资源图片" prop="ziyuantupian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="资源简介" prop="ziyuanjianjie">
            <editor 
