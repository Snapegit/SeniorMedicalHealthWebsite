...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="血压" prop="xueya">
			<el-input-number v-model="ruleForm.xueya" placeholder="血压" :readonly="ro.xueya"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="血脂" prop="xuezhi">
			<el-input-number v-model="ruleForm.xuezhi" placeholder="血脂" :readonly="ro.xuezhi"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="血糖" prop="xuetang">
			<el-input-number v-model="ruleForm.xuetang" placeholder="血糖" :readonly="ro.xuetang"></el-input-number>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="心率" prop="xinlv">
