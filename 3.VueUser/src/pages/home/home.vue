...
<!-- 商品推荐 -->
<div id="animate_recommendjiaoyuziyuan" class="recommend animate__animated" :style='{"width":"100%","padding":"20px 0","margin":"0 0 20px","background":"#f1f1f1","order":"1"}'>
    ...
    <div class="title" :style='{"width":"100%","margin":"30px auto","lineHeight":"50px","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230915/b96d1e15768f4ac495e60a79e04cb731.png) no-repeat center top"}'>
		<span :style='{"color":"#F5BB00","fontSize":"32px","lineHeight":"40px"}'>教育资源推荐</span>
	</div>
	...
	<div v-if="jiaoyuziyuanRecommend.length" class="list list12 index-pv1 list12jiaoyuziyuan" :style='{"width":"100%","padding":"0 7%","background":"none","height":"auto"}'>
	  <div class="list" :style='{"margin":"30px 0 0","overflow":"hidden","flexWrap":"wrap","flex":"1","background":"none","display":"flex","height":"auto"}'>
	    <div :style='{"cursor":"pointer","width":"31.3%","margin":"0 2% 20px 0","overflow":"hidden","position":"relative","height":"auto"}' class="item list-item animation-box" v-for="item,index in jiaoyuziyuanRecommend" :key="index" @click="toDetail('jiaoyuziyuanDetail', item)">
			<img :name="item.id" :style='{"width":"100%","margin":"0 0 6px","objectFit":"cover","borderRadius":"6px","display":"block","height":"280px"}' v-if="preHttp(item.ziyuantupian)" :src="item.ziyuantupian.split(',')[0]" alt="" />
			<img :name="item.id" :style='{"width":"100%","margin":"0 0 6px","objectFit":"cover","borderRadius":"6px","display":"block","height":"280px"}' v-else :src="baseUrl + (item.ziyuantupian?item.ziyuantupian.split(',')[0]:'')" alt="" />
			<div class="line1" :style='{"padding":"0 10px","borderColor":"#ddd","margin":"0 0 6px","whiteSpace":"nowrap","color":"#333","overflow":"hidden","borderRadius":"6px","borderWidth":"0 0 1px","background":"#fff","width":"100%","lineHeight":"36px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"solid"}'>{{item.ziyuanmingcheng}}</div>
			<div class="line1" :style='{"padding":"0 10px","borderColor":"#ddd","margin":"0 0 6px","whiteSpace":"nowrap","color":"#333","overflow":"hidden","borderRadius":"6px","borderWidth":"0 0 1px","background":"#fff","width":"100%","lineHeight":"36px","fontSize":"14px","textOverflow":"ellipsis","borderStyle":"solid"}'>{{item.ziyuanleixing}}</div>
	    </div>
	  </div>
	</div>
	...
	<div @click="moreBtn('jiaoyuziyuan')" :style='{"border":"0","cursor":"pointer","margin":"0px auto 20px","borderRadius":"6px","textAlign":"center","background":"#F5BB00","display":"block","width":"120px","lineHeight":"36px"}'>
		<span :style='{"color":"#f5f5f5","fontSize":"14px"}'>查看更多</span>
		<i :style='{"color":"#f5f5f5","fontSize":"12px"}' class="icon iconfont icon-gengduo1"></i>
	</div>
    ...
    methods: {
		...
		handleScroll() {
			let arr = [
				...
				{id:'animate_recommendjiaoyuziyuan',css:'animate__fadeInUp'},
      ...
      preHttp(str) {
		...
		getList() {
			let autoSortUrl = "";
			let data = {}
          autoSortUrl = "jiaoyuziyuan/autoSort";
			data = {
				page: 1,
				limit: 6,
			}
			this.$http.get(autoSortUrl, {params: data}).then(res => {
				if (res.data.code == 0) {
					this.jiaoyuziyuanRecommend = res.data.data.list;
