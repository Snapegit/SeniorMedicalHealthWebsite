...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    <el-form
      ...
      label-width="180px"
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="食物名称" prop="shiwumingcheng">
            <el-input v-model="ruleForm.shiwumingcheng" 
                placeholder="食物名称" clearable :disabled=" false  ||ro.shiwumingcheng"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="食物图片" v-if="type!='cross' || (type=='cross' && !ro.shiwutupian)" prop="shiwutupian">
            <file-upload
            tip="点击上传食物图片"
            action="file/upload"
            :limit="3"
            ...
            <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' class="upload" v-else label="食物图片" prop="shiwutupian">
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="饮食分量" prop="yinshifenliang">
            <el-input v-model="ruleForm.yinshifenliang" 
                placeholder="饮食分量" clearable :disabled=" false  ||ro.yinshifenliang"></el-input>
          </el-form-item>
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="饮食频率" prop="yinshipinlv">
            <el-input v-model="ruleForm.yinshipinlv" 
                placeholder="饮食频率" clearable :disabled=" false  ||ro.yinshipinlv"></el-input>
          </el-form-item>
